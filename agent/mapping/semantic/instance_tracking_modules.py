...
class InstanceMemory:
    ...
    def __init__(
        ...
        if config is not None:
            self.save_dir = os.path.join(config.DUMP_LOCATION, "instances",
                                         config.EXP_NAME)
        else:
    ...
    def update_instance_id(self, env_id: int, local_instance_id: int,
        ...
        self.local_id_to_global_id_map[env_id][
            local_instance_id] = global_instance_id
        if self.debug_visualize:
            category_name = (
