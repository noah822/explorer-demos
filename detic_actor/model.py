...
class SemanticMoudle:
    ...
    def __call__(self, img: np.ndarray, accept_threshold=0.5):
       ...
       # shift all class id by addig 1, 0 is reserved for nothing class
       instance_classes = [self.categories_mapping.get(raw_id, -1)+1 for raw_id in seg_res['instance_classes']]
